...
df = pd.DataFrame(0, index = np.arange(len(test_frt)), columns = column_names)
...
outGT, outPRED, aurocMean, aurocIndividual = EnsemAgg(EnsemTest, dataLoaderTest_frt, nnClassCount, class_names)
