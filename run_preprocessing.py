...
data_path = '/media/leelabsg-storage1/wonyoung/leelab/CXR/CheXpert/CheXpert-v1.0-small'
...
Validdata = pd.read_csv(os.path.join(data_path, 'valid.csv'))
...
Testdata = pd.read_csv(os.path.join(data_path, 'valid.csv'))
