...
Testdata_frt['Study'] = Testdata_frt.copy().Path.str.split('/').str[2] + '/' + Testdata_frt.copy().Path.str.split('/').str[3]
Testdata_frt_agg = Testdata_frt.copy().groupby('Study').agg('first').reset_index()
